...
public class TestR2_SimpleElements {
	...
	public void testConnections(){
		...
		assertSameElement("Wrong output for element src, ", tap, src.getOutput());
		assertSameElement("Wrong output for element tap, ", sink, tap.getOutput());
	}
	...
	public void testSinkConnect(){
		...
		assertSameElement("Connect on a sink should have no effect, ", none, out);
	}
