...
public class Food {
	...
	public Map<String,NutritionalElement> elencoRowMaterials=new TreeMap<>();
	public Map<String,NutritionalElement> elencoProducts=new TreeMap<>();
	public Map<String,NutritionalElement> elencoRecipes=new TreeMap<>();
	...
	public void defineRawMaterial(String name,
		...
		elencoRowMaterials.put(name, new RawMaterials(name, calories, proteins, carbs, fat));
	...
	public Collection<NutritionalElement> rawMaterials(){
		...
		return elencoRowMaterials.values();
	}
	...
	public NutritionalElement getRawMaterial(String name){
		...
		return elencoRowMaterials.get(name);
	}
	...
	public void defineProduct(String name,
		...
		elencoProducts.put(name, new Prodotti(name, calories, proteins, carbs, fat));
	...
	public NutritionalElement getProduct(String name){
		return elencoProducts.get(name);
	}
	...
	public Recipe createRecipe(String name) {
		...
		Recipe e=new Recipe(name,this);
		elencoRecipes.put(name,e);
