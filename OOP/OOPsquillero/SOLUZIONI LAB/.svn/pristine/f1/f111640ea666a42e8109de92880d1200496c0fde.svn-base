...
public class TestR4_Simulation {
	...
	public void testSplit(){
		...
		assertTrue("Missing simulation trace for element T",obs.contains("T"));
	...
	public void testMissingFlow(){
		...
		assertTrue("Missing simulation trace for element Src",obs.contains("Src"));
		assertTrue("Missing simulation trace for element Sink",obs.contains("Sink"));
	...
	private static class StoreObserver implements SimulationObserver {
		...
		void assertHasType(String name, String expectedType) {
			if(!events.containsKey(name.toLowerCase())) 
				fail("Missing simulation trace for element " + name);
