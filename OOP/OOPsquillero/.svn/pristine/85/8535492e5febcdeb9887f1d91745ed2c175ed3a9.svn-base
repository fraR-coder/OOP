...
public final class MainApp {
	...
	void example2() throws InterruptedException {
		...
		manager.submit(new Thread(new Counter(100, "Alice")));
		manager.submit(new Thread(new Counter(100, "Bob")));
		manager.submit(new Thread(new Counter(100, "Carl")));
		manager.submit(new Thread(new Counter(100, "Diana")));
		manager.shutdown();
